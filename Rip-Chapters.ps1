...
$inputDriveLetter = "E:\Video\backup\Pokemon Disc 9.iso"

# File Path to Create file in 
$outputFilePath = "D:\pokemon\Disk1\" 
...
$showName = "Pokemon Indigo League"

# Title's offset for the episode number
$episodeNumberInTitleOffset = 77
...
$expectedTimeSpan = New-TimeSpan -Minutes 21 -Seconds 35
